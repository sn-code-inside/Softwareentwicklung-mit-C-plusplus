========================================================================
    KONSOLENANWENDUNG: Auf2KB-Projektübersicht
========================================================================

Diese Auf2KB-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf2KB-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf2KB.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
