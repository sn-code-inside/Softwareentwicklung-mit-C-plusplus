...
/*===========================================================================*/
/* Desc.: Es wird das File mit dem Namen strFName_ geschrieben               */
/* In   : -                                                                  */
/* Out  : true: Schreiben erfolgreich; sonst false                           */
/*===========================================================================*/
/*---------------------------------------------------------------------------*/
bool cFUtils::writeFile (char *str)       
/*---------------------------------------------------------------------------*/
{   
    bool bOk = false;
    ofstream outFile(strFName_, ios::out|ios::app|ios::binary);                  
    if (outFile.good()) 
    {
