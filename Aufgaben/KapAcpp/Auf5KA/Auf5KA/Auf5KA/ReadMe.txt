========================================================================
    KONSOLENANWENDUNG: Auf5KA-Projektübersicht
========================================================================

Diese Auf5KA-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf5KA-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf5KA.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
