========================================================================
    KONSOLENANWENDUNG: Auf1KA-Projektübersicht
========================================================================

Diese Auf1KA-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf1KA-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf1KA.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
