========================================================================
    KONSOLENANWENDUNG: Auf2K6-Projektübersicht
========================================================================

Diese Auf2K6-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf2K6-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf2K6.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
