========================================================================
    KONSOLENANWENDUNG: Auf1K5-Projektübersicht
========================================================================

Diese Auf1K5-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf1K5-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf1K5.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
