========================================================================
    KONSOLENANWENDUNG: Auf4K5-Projektübersicht
========================================================================

Diese Auf4K5-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf4K5-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf4K5.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
