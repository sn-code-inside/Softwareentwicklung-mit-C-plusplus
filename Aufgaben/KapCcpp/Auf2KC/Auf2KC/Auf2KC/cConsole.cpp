...
/*===========================================================================*/
/* Desc.: Setzt den Cursor an die Pos Pos                                    */
/* In   : COORD Pos: ZielPosition                                            */
/* Out  : -                                                                  */
/*===========================================================================*/
void cConsole::GotoPos (COORD Pos)                                                 
{
    SetConsoleCursorPosition (hConsole_, Pos);
}
/*===========================================================================*/
/* Desc.: Macht den Cursor unsichtbar                                        */
/* In   : -                                                                  */
/* Out  : -                                                                  */
/*===========================================================================*/
void cConsole::HideCursor (void)                                                 
{
    CONSOLE_CURSOR_INFO cInfo;
    GetConsoleCursorInfo (hConsole_, &cInfo);
    cInfo.bVisible = FALSE;
    SetConsoleCursorInfo (hConsole_, &cInfo);
}
/*===========================================================================*/
/* Desc.: Macht den Cursor sichtbar                                          */
/* In   : -                                                                  */
/* Out  : -                                                                  */
/*===========================================================================*/
void cConsole::ShowCursor (void)                                                 
{
    CONSOLE_CURSOR_INFO cInfo;
    GetConsoleCursorInfo (hConsole_, &cInfo);
    cInfo.bVisible = TRUE;
