========================================================================
    KONSOLENANWENDUNG: Auf2KE-Projektübersicht
========================================================================

Diese Auf2KE-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf2KE-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf2KE.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
