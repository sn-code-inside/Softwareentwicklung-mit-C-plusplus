========================================================================
    KONSOLENANWENDUNG: Auf9K4-Projektübersicht
========================================================================

Diese Auf9K4-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Auf9K4-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Auf9K4.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
