========================================================================
    KONSOLENANWENDUNG: P03KA_FileWrite-Projektübersicht
========================================================================

Diese P03KA_FileWrite-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P03KA_FileWrite-Anwendung besteht.


P03KA_FileWrite.vcxproj
...
P03KA_FileWrite.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P03KA_FileWrite.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
