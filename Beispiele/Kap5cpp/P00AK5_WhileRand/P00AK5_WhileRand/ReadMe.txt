========================================================================
    KONSOLENANWENDUNG: P00AK5_WhileRand-Projektübersicht
========================================================================

Diese P00AK5_WhileRand-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P00AK5_WhileRand-Anwendung besteht.


P00AK5_WhileRand.vcxproj
...
P00AK5_WhileRand.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P00AK5_WhileRand.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
