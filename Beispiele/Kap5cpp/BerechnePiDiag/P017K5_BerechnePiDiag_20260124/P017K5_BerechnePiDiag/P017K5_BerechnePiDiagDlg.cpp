...
BEGIN_MESSAGE_MAP(CP017K5BerechnePiDiagDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//ON_BN_CLICKED(IDC_BUTTON1, &CP017K5BerechnePiDiagDlg::OnBnOpenPictureDlg)
	ON_BN_CLICKED(IDCANCEL, &CP017K5BerechnePiDiagDlg::OnBnClickedCancel)
	//ON_BN_CLICKED(IDC_BUTTON_CreatePoints, &CP017K5BerechnePiDiagDlg::OnBnClickedButtonCreatepoints)
...
void CP017K5BerechnePiDiagDlg::OnBnClickedButtonCreatepoints()
{
	// TODO: Fügen Sie hier Ihren Handlercode für Benachrichtigungen des Steuerelements ein.
	CreatePointExample();
}
