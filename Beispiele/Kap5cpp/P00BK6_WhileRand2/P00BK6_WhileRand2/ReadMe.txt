========================================================================
    KONSOLENANWENDUNG: P00BK6_WhileRand2-Projektübersicht
========================================================================

Diese P00BK6_WhileRand2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P00BK6_WhileRand2-Anwendung besteht.


P00BK6_WhileRand2.vcxproj
...
P00BK6_WhileRand2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P00BK6_WhileRand2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
