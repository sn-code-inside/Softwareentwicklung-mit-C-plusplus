========================================================================
    KONSOLENANWENDUNG: P007K5_forFall-Projektübersicht
========================================================================

Diese P007K5_forFall-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P007K5_forFall-Anwendung besteht.


P007K5_forFall.vcxproj
...
P007K5_forFall.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P007K5_forFall.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
