========================================================================
    KONSOLENANWENDUNG: P011K5_continue-Projektübersicht
========================================================================

Diese P011K5_continue-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P011K5_continue-Anwendung besteht.


P011K5_continue.vcxproj
...
P011K5_continue.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P011K5_continue.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
