========================================================================
    KONSOLENANWENDUNG: P003KB_TemplFkt2-Projektübersicht
========================================================================

Diese P003KB_TemplFkt2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P003KB_TemplFkt2-Anwendung besteht.


P003KB_TemplFkt2.vcxproj
...
P003KB_TemplFkt2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P003KB_TemplFkt2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
