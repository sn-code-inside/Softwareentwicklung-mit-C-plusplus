========================================================================
    KONSOLENANWENDUNG: P004KA_Abstract-Projektübersicht
========================================================================

Diese P004KA_Abstract-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P004KA_Abstract-Anwendung besteht.


P004KA_Abstract.vcxproj
...
P004KA_Abstract.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P004KA_Abstract.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
