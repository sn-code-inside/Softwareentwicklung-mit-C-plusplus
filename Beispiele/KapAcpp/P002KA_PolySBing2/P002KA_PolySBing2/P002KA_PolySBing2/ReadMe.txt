========================================================================
    KONSOLENANWENDUNG: P002KA_PolySBing2-Projektübersicht
========================================================================

Diese P002KA_PolySBing2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P002KA_PolySBing2-Anwendung besteht.


P002KA_PolySBing2.vcxproj
...
P002KA_PolySBing2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P002KA_PolySBing2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
