========================================================================
    KONSOLENANWENDUNG: P002K7_TryThrowCatch-Projektübersicht
========================================================================

Diese P002K7_TryThrowCatch-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P002K7_TryThrowCatch-Anwendung besteht.


P002K7_TryThrowCatch.vcxproj
...
P002K7_TryThrowCatch.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P002K7_TryThrowCatch.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
