...
// P08K7_TestDlg.cpp: Definiert das Klassenverhalten für die Anwendung.
//

#include "pch.h"

#include "framework.h"
#include "P08K7_TestDlg.h"
#include "P08K7_TestDlgDlg.h"
...
BEGIN_MESSAGE_MAP(CP08K7TestDlgApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CP08K7TestDlgApp-Erstellung

CP08K7TestDlgApp::CP08K7TestDlgApp()
{
...
// Das einzige CP08K7TestDlgApp-Objekt

CP08K7TestDlgApp theApp;


// CP08K7TestDlgApp-Initialisierung

BOOL CP08K7TestDlgApp::InitInstance()
{
	...
	MessageBox(NULL, str, L"Test CCommandLineInfo", MB_OK);
