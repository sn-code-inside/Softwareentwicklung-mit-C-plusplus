========================================================================
    KONSOLENANWENDUNG: P0AK7_STDMeth2-Projektübersicht
========================================================================

Diese P0AK7_STDMeth2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P0AK7_STDMeth2-Anwendung besteht.


P0AK7_STDMeth2.vcxproj
...
P0AK7_STDMeth2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P0AK7_STDMeth2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
