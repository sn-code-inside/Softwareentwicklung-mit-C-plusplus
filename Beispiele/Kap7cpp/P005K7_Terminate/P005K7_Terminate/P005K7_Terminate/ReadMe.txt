========================================================================
    KONSOLENANWENDUNG: P005K7_Terminate-Projektübersicht
========================================================================

Diese P005K7_Terminate-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P005K7_Terminate-Anwendung besteht.


P005K7_Terminate.vcxproj
...
P005K7_Terminate.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P005K7_Terminate.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
