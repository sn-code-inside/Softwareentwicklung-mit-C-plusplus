========================================================================
    KONSOLENANWENDUNG: P007K9_cpyConst-Projektübersicht
========================================================================

Diese P007K9_cpyConst-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P007K9_cpyConst-Anwendung besteht.


P007K9_cpyConst.vcxproj
...
P007K9_cpyConst.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P007K9_cpyConst.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
