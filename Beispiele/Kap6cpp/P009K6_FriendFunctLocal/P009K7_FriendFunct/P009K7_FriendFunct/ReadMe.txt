========================================================================
    KONSOLENANWENDUNG: P009K7_FriendFunct-Projektübersicht
========================================================================

Diese P009K7_FriendFunct-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P009K7_FriendFunct-Anwendung besteht.


P009K7_FriendFunct.vcxproj
...
P009K7_FriendFunct.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P009K7_FriendFunct.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
