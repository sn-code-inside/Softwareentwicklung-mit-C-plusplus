...
{
    public:
        int addToPriv (cFriendFunct&, int);
};

class cFriendFunct                                                                                       
{ 
    friend int cAdd::addToPriv (cFriendFunct&, int);            //1
    public:
        cFriendFunct (int);                                                                                           //1
        ~cFriendFunct (void);                                   
    ...
    private:
        int iMyTest_;                                           //3 
        //int iTTT; Bei Hinzunahme dieser Var verdoppelt sich sizeof(cFriendFunct);
};                                        
...
int cAdd::addToPriv (cFriendFunct& friendVar, int iAdd)
{
...
{
    //=========================================
    CONST WCHAR * str = L"P009K6_FriendFunctLocal";
    printConsole (str);
    //=========================================  
    ...
    cout << "Ausgabe der privaten Var via friendFkt.: " << 
            add.addToPriv (myFriend, 5) << endl;                //9
