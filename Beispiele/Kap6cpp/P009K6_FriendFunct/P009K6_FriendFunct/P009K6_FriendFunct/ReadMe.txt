========================================================================
    KONSOLENANWENDUNG: P009K6_FriendFunct-Projektübersicht
========================================================================

Diese P009K6_FriendFunct-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P009K6_FriendFunct-Anwendung besteht.


P009K6_FriendFunct.vcxproj
...
P009K6_FriendFunct.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P009K6_FriendFunct.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
