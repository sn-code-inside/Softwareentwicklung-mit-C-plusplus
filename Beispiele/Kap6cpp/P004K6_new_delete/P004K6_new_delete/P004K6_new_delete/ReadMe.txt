========================================================================
    KONSOLENANWENDUNG: P004K6_new_delete-Projektübersicht
========================================================================

Diese P004K6_new_delete-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P004K6_new_delete-Anwendung besteht.


P004K6_new_delete.vcxproj
...
P004K6_new_delete.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P004K6_new_delete.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
