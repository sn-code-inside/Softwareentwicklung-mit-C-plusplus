========================================================================
    KONSOLENANWENDUNG: P004K4_Struct2-Projektübersicht
========================================================================

Diese P004K4_Struct2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P004K4_Struct2-Anwendung besteht.


P004K4_Struct2.vcxproj
...
P004K4_Struct2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P004K4_Struct2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
