========================================================================
    KONSOLENANWENDUNG: P00CK4_FloatGenau-Projektübersicht
========================================================================

Diese P00CK4_FloatGenau-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P00CK4_FloatGenau-Anwendung besteht.


P00CK4_FloatGenau.vcxproj
...
P00CK4_FloatGenau.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P00CK4_FloatGenau.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
