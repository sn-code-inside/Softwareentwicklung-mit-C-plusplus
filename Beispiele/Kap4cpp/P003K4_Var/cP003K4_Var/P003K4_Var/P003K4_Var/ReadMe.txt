========================================================================
    KONSOLENANWENDUNG: P003K4_Var-Projektübersicht
========================================================================

Diese P003K4_Var-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P003K4_Var-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P003K4_Var.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
