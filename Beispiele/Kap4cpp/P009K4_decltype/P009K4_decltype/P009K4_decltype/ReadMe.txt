========================================================================
    KONSOLENANWENDUNG: P009K4_decltype-Projektübersicht
========================================================================

Diese P009K4_decltype-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P009K4_decltype-Anwendung besteht.


P009K4_decltype.vcxproj
...
P009K4_decltype.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P009K4_decltype.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
