========================================================================
    KONSOLENANWENDUNG: P005K4_StructSizes-Projektübersicht
========================================================================

Diese P005K4_StructSizes-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P005K4_StructSizes-Anwendung besteht.


P005K4_StructSizes.vcxproj
...
P005K4_StructSizes.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P005K4_StructSizes.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
