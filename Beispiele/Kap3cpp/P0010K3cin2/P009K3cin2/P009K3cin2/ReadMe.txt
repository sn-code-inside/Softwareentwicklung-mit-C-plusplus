========================================================================
    KONSOLENANWENDUNG: P009K3cin2-Projektübersicht
========================================================================

Diese P009K3cin2-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P009K3cin2-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P009K3cin2.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
