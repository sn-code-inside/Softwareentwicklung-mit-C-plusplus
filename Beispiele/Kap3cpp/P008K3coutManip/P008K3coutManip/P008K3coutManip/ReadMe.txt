========================================================================
    KONSOLENANWENDUNG: P008K3coutManip-Projektübersicht
========================================================================

Diese P008K3coutManip-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P008K3coutManip-Anwendung besteht.


P008K3coutManip.vcxproj
...
P008K3coutManip.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P008K3coutManip.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
