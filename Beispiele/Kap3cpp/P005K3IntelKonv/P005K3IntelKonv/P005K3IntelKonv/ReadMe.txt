========================================================================
    KONSOLENANWENDUNG: P005K3IntelKonv-Projektübersicht
========================================================================

Diese P005K3IntelKonv-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre P005K3IntelKonv-Anwendung besteht.


P005K3IntelKonv.vcxproj
...
P005K3IntelKonv.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen P005K3IntelKonv.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
